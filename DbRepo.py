...
class DbRepo:
    ...
    def drop_all_tables(self):
        self.local_session.execute('DROP TABLE users')
        self.local_session.execute('DROP TABLE user_roles')
        self.local_session.execute('DROP TABLE tickets')
        self.local_session.execute('DROP TABLE flights')
        self.local_session.execute('DROP TABLE customers')
        self.local_session.execute('DROP TABLE countries')
        self.local_session.execute('DROP TABLE airline_companies')
        self.local_session.execute('DROP TABLE administrators')
        self.local_session.commit()
